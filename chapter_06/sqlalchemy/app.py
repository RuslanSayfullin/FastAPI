...
from chapter_06.sqlalchemy.models import Post
from chapter_06.sqlalchemy import schemas
from chapter_06.sqlalchemy.database import create_all_tables, get_async_session


@contextlib.asynccontentmanager
...
async def get_post_or_404(
    id: int, session: AsyncSession = Depends(get_async_session)) -> Post:
...
@app.post("/posts", response_model=schemas.PostRead, status_code=status.HTTP_201_CREAT)
